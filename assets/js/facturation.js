...
/* PRIX HT */
    prixHT.value = prixTotal.value + prixTotal2.value + prixTotal3.value + prixTotal4.value + prixTotal5.value;
    prixHT.innerHTML = prixHT.value + ' €';
/* TVA */
    tva.value = prixHT.value * 0.20;
    tva.innerHTML = tva.value + ' €';
/* TTC */
    ttc.value = prixHT.value * 1.20;
